...
int rem=(sum%7);
if(rem==0)
printf("SSSSSSaturday ");
else if(rem==1)
printf("SSSSSundayyyyy");
else if(rem==2)
printf("MMMMMMondayyyyyy");
else if(rem==3)
printf("TTTTTuesdayyyyyyyyyy");
else if(rem==4)
printf("WWWWWWWednesdayyyy");
else if(rem==5)
printf("TTTTTTThursdayyyyy ");
else if(rem==6)
printf("FFFFFFFridayyyy");
}
